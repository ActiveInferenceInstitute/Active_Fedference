...
| `src/fedference_cli/` | Stable parser/command/support boundaries, explicit output and receipt policy | Domain formulas, parser-owned file writes, silent fallback to another checkout |
