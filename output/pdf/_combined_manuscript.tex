...
\vspace{0.08em}
{\small\sffamily DOI: \href{https://doi.org/10.5281/zenodo.21919307}{10.5281/zenodo.21919307}\par}
\vspace{0.35em}
\makeatletter
{\@date\par}
\makeatother
...
release DOI is
\href{https://doi.org/10.5281/zenodo.21919307}{10.5281/zenodo.21919307},
...
orders, not performance guarantees: agent-axis slopes are 0.90
(log-linear), 0.94 (iterative robust), 0.70 (variational), 1.59 (naive
self-excluding sharing), and 1.93 (robust self-excluding sharing);
state-axis slopes are 0.40, 0.41, and 0.42; the modality-axis inference
...
\item
  Project test suite: 1670 collected cases; the bound successful receipt
  records zero failed cases. The project no-mocks policy remains a
  separately executable source contract.
\item
  Line coverage on \texttt{src/}: 91.15\% (achieved by the bound full
