...
\ifXeTeX
\special{pdf:trailerid [ <493ee26f14ab62f3bee931d9e8f167f8> <493ee26f14ab62f3bee931d9e8f167f8> ]}
\fi
\ifPDFTeX
\pdftrailerid{}
\pdftrailer{/ID [ <493ee26f14ab62f3bee931d9e8f167f8> <493ee26f14ab62f3bee931d9e8f167f8> ]}
\fi
\ifLuaTeX
\pdfvariable trailerid {[ <493ee26f14ab62f3bee931d9e8f167f8> <493ee26f14ab62f3bee931d9e8f167f8> ]}
\fi
...
(log-linear), 0.94 (iterative robust), 0.71 (variational), 1.59 (naive
self-excluding sharing), and 1.93 (robust self-excluding sharing);
state-axis slopes are 0.42, 0.40, and 0.41; the modality-axis inference
...
carries project test coverage of 90.04\% (gate \(\ge 90\%\)), with every
...
\item
  Project test suite: 1559 collected cases; the bound successful receipt
  records zero failed cases. The project no-mocks policy remains a
  separately executable source contract.
\item
  Line coverage on \texttt{src/}: 90.04\% (achieved by the bound full
