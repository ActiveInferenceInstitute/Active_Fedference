...
`generate_cross_study_summary` runs a {{CROSS_STUDY_N_SEEDS}}-seed ($n_{\text{seeds}} = {{CROSS_STUDY_N_SEEDS}}$) ensemble
over Studies 1--9 and reports the mean ± {{CI_PERCENT}} % bootstrap CI of the key
