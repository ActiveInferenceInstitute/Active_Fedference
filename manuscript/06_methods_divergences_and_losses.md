...
{{RECOVERY_RENYI_MAXDIFF}} (reported in [@sec:results-recovery]).
...
\(\beta\to0\) discrepancy from the NLL closed form is {{RECOVERY_BETA_MAXDIFF}}
and the largest \(q_{\rm loss}\to0\) discrepancy is {{RECOVERY_RCCE_MAXDIFF}}
