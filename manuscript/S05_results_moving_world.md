...
isolated and communicating consensus for {{V4_N_AGENTS}} agents, each observing
a non-overlapping {{V4_FOV_WIDTH}}-position window of a
{{V4_N_POSITIONS}}-position world. Panel B compares EFE-guided and random
movement for {{V4_EFE_N_AGENTS}} agents in a
{{V4_EFE_N_POSITIONS}}-position world. The x-axis is the condition or movement
